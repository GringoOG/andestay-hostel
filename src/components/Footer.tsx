...
function SocialLink({
  ...
  return (
    <a
      ...
      aria-label={label}
      title={label}
      className="inline-flex h-11 w-11 items-center justify-center rounded-full text-white transition hover:bg-white/10 hover:opacity-100"
    >
      {children}
    </a>
  );
    ...
    <footer className="bg-[var(--forest-deep)] pb-[max(0px,var(--safe-bottom))] text-[rgba(255,255,255,0.88)]">
      <div className="site-wrap border-b border-white/10 py-5 sm:py-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-1 opacity-90 sm:gap-2">
            <SocialLink href={site.instagramUrl} label="Instagram">
              <InstagramIcon className="h-5 w-5" />
            </SocialLink>
            <SocialLink href={site.tiktokUrl} label="TikTok">
